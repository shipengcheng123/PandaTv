...
import jiyun.com.ipandatv.fragment.pandadirect.ptersenter.PandaNaxieshiPresenter;

/**
 * Created by INS7566 on 2017/7/14.
 */

public class PandaNaxieshiFragment extends BaseFragment implements LiveTwoContract.View{
    @BindView(R.id.jcyk_pullrecycler)
    PullToRefreshRecyclerView jcykPullrecycler;
    Unbinder unbinder;
    private PandaNaxieshiAdapetr adapter;
    private List<PandaNaxieshiBean.VideoBean> mList=new ArrayList<>();
    private LiveTwoContract.Presenter presenter;
    private int Index=1;
    private PandaNaxieshiPresenter presente;
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(getActivity(),3);
    ...
    public void showpandanaxieshiFragment(PandaNaxieshiBean pandaNaxieshiBean) {
        mList.addAll(pandaNaxieshiBean.getVideo());
