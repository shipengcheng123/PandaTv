...
public class PandaNaxieshiAdapetr extends BaseAdapter<PandaNaxieshiBean.VideoBean> {
    public PandaNaxieshiAdapetr(Context context, List<PandaNaxieshiBean.VideoBean> datas) {
        super(context, R.layout.adapter_jcyk, datas);
    }

    @Override
    public void convert(ViewHolder holder, final PandaNaxieshiBean.VideoBean bean) {
