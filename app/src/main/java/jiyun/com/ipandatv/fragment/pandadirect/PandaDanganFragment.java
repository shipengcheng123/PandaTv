...
import jiyun.com.ipandatv.fragment.pandadirect.ptersenter.PandaDanganPresenter;

/**
 * Created by INS7566 on 2017/7/14.
 */

public class PandaDanganFragment extends BaseFragment implements LiveTwoContract.View{
    @BindView(R.id.jcyk_pullrecycler)
    PullToRefreshRecyclerView jcykPullrecycler;
    Unbinder unbinder;
    private PandaDanganAdapter adapter;
    private List<PandaDanganBean.VideoBean> mList=new ArrayList<>();
    private LiveTwoContract.Presenter presenter;
    private int Index=1;
    private PandaDanganPresenter presente;
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(getActivity(),3);
        ...
        adapter = new PandaDanganAdapter(getContext(),mList);
    ...
    protected void loadData() {
        ...
        presente=new PandaDanganPresenter(this);
        presenter.start();
    ...
    public void showxiongmaoDanganFragment(PandaDanganBean pandaDanganBean) {
        mList.addAll(pandaDanganBean.getVideo());
    ...
    public void showMessage(String msg) {
        ...
        PandaDanganBean pandaChaomenggunxiuObject =
                (PandaDanganBean) aCache.getAsObject("PandaDanganBean");
