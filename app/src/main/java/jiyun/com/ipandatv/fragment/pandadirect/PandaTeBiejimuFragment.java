...
import jiyun.com.ipandatv.fragment.pandadirect.ptersenter.PandaTeBiejiemuPresenter;

/**
 * Created by INS7566 on 2017/7/14.
 */

public class PandaTeBiejimuFragment extends BaseFragment implements LiveTwoContract.View{
    @BindView(R.id.jcyk_pullrecycler)
    PullToRefreshRecyclerView jcykPullrecycler;
    Unbinder unbinder;
    private PandaTeBiejiemuAdapter adapter;
    private List<PandaTeBiejimuBean.VideoBean> mList=new ArrayList<>();
