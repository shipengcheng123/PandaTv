...
import jiyun.com.ipandatv.fragment.pandadirect.ptersenter.PandaChaomengPresenter;

/**
 * Created by INS7566 on 2017/7/14.
 */

public class PandaChaomenggunxiuFragment extends BaseFragment implements LiveTwoContract.View {
    @BindView(R.id.jcyk_pullrecycler)
    PullToRefreshRecyclerView jcykPullrecycler;
    Unbinder unbinder;
    private PandaChaomengAdapter adapter;
    private List<PandaChaomenggunxiuBean.VideoBean> mList=new ArrayList<>();
