...
public class PandaJCYKAdapter extends BaseAdapter<PandaLiveJcyiBean.VideoBean>{
    private Dao<JiluDao,Integer> dao;
    private boolean quchong=false;
    public PandaJCYKAdapter(Context context, List<PandaLiveJcyiBean.VideoBean> datas) {
        super(context, R.layout.adapter_jcyk, datas);
    }

    @Override
    public void convert(ViewHolder holder, final PandaLiveJcyiBean.VideoBean bean) {
